...
Uit onderzoek van \textcite{BongardBlanchy2021} blijkt dat gebruikers van digitale platformen zoals Netflix vaak moeite hebben met het herkennen van deze patronen. Zelfs wanneer ze zich bewust zijn van de toepassing van dark patterns, blijven ze hierdoor beïnvloed worden \autocite{BongardBlanchy2021}, wat wijst op hoe subtiel en manipulatief deze patronen kunnen zijn. Daarnaast leiden dark patterns tot heel wat onbedoelde keuzes die minder leuke gevolgen hebben, zoals het onbewust afsluiten van een abonnement of het betalen van een verborgen extra kost \autocite{FODEconomie2024}.

\vspace{1em}

Ondanks dat er veel onderzoek werd gedaan naar dark patterns vanuit het standpunt van zij die er gebruik van maken, denk maar aan de studies van \textcite{Kitkowska2023}, \textcite{Kollmer2022}, \textcite{Gunawan2021}, \textcite{OECD2022}..., zijn er weinig studies die de effecten van deze patronen op gebruikersgedrag en gebruikerservaring onder de loep nemen \autocite{BongardBlanchy2021}. Daarbovenop benadrukt de studie van \textcite{DiGeronimo2020} de nood aan verder onderzoek om manieren te vinden die bewustwording bij gebruikers stimuleren door middel van de ontwikkeling van geautomatiseerde en educatieve tools. Uit deze bevindingen werd onderstaande onderzoeksvraag voor dit onderzoek opgesteld:

\vspace{1em}

\begin{quote}    
    \textit{``Hoe kunnen commerciële dark patterns van in Vlaanderen vaak gebruikte streamingdiensten automatisch opgespoord en aan de gebruikers gesignaleerd worden?''}
\end{quote}
...
Als uiteindelijk doel van dit onderzoek wordt er achterhaald welke manier het beste is om dark patterns op streamingplatformen op een gebruiksvriendelijke manier te signaleren aan gebruikers. Naast de scriptie wordt als concreet eindresultaat eveneens een Proof of Concept (PoC) uitgewerkt, gebaseerd op de bevindingen uit dit onderzoek. Deze PoC wordt tot slot bij een kleine groep jongvolwassenen (18-34 jaar) getest om na te gaan hoe het voor de gebruiker aanvoelt om aan de slag te gaan met een dergelijke tool. De resultaten van deze kleine test geven een eerste indicatie over de gebruiksvriendelijkheid van de voorgestelde oplossing.
...
In eerste instantie zullen er wireframes en mockups uitgewerkt worden in \emph{AdobeXD} om de algemene flow van de tool te bepalen. Nadien zullen in overleg met de copromotoren de meest geschikte technologieën (zoals \emph{React}, \emph{Node.js}, \emph{Python}, \ldots) gekozen worden. Daarna start de implementatie van de tool. Tijdens de ontwikkeling wordt er iteratief en agile gewerkt, waarbij het resultaat van elke iteratie zal worden afgetoetst bij de copromotoren. Daarnaast zullen er testen geschreven worden die de goede werking van de tool waarborgen.
...
Het verwachte resultaat van dit onderzoek is een digitale tool die Vlamingen tussen 18 en 34 jaar ondersteunt bij het automatisch opsporen en signaleren van dark patterns op populaire streamingdiensten. De tool zal hen ondersteunen bij het opmerken van misleidende technieken en zal de gebruikers informeren over de intentie en gevaren ervan. Deze verwachting baseert zich op bevindingen uit de literatuurstudie, namelijk dat gebruikers regelmatig moeite hebben bij het herkennen van dark patterns \autocite{OECD2022} en dat ze niet bewust zijn van de gevaren ervan \autocite{BongardBlanchy2021}. Daarnaast wordt verwacht dat de tool niet hoofdzakelijk AI zal gebruiken aangezien uit de literatuurstudie gebleken is dat bestaande detectietools gebruikmakend van AI een beperkte dekking bieden \autocite{Nie2024} en dus onmogelijk alle patronen kunnen herkennen en ervoor waarschuwen. Eveneens wordt, naast de uitgewerkte tool, aangenomen dat het onderzoek inzichten zal geven in op welke manier gebruikers het best geïnformeerd en gewaarschuwd kunnen worden. 

\vspace{1em}

De verwachte meerwaarde van dit onderzoek voor de doelgroep ligt in het verhogen van het vermogen van gebruikers om dark patterns tijdig te herkennen en de gevolgen van deze patronen in te zien. Verder biedt dit onderzoek waardevolle inzichten voor de wereld van UI/UX en softwareontwikkeling, doordat het kan dienen als voorbeeld voor het ontwerpen van soortgelijke tools in andere domeinen waar dark patterns voorkomen, zoals webshops of reiswebsites.
