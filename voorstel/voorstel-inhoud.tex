...
Zoals in het begin van dit voorstel werd aangehaald, richt dit onderzoek zich op het zoeken naar een geschikte tool die jongvolwassen gebruikers in staat stelt om dark patterns op streamingdiensten te herkennen, en zo bewustwording rond dit onderwerp te creëren. Om de onderzoeksvraag te beantwoorden, wordt een weloverwogen plan gevolgd dat bestaat uit \textbf{zes verschillende fasen}. In eerste instantie wordt de huidige stand van zaken onderzocht aan de hand van een literatuurstudie. Nadien worden hieruit de requirements waaraan de tool moet voldoen opgesteld. Vervolgens zal een longlist gemaakt worden van alle mogelijke oplossingen. Deze zal verder vernauwd worden tot een shortlist die de meest geschikte tools bevat voor deze casus die eveneens rekening houdt met de doelgroep. Hieruit zal de meest geschikte aanpak gekozen en uitgewerkt worden als Proof of Concept. Tot slot zal uit dit onderzoek een conclusie geformuleerd worden. Naast deze gedefinieerde fasen wordt er tijdens het volledige verloop van het onderzoek continu documentatie bijgehouden. Iedere fase is zorgvuldig gepland om een optimaal verloop van de bachelorproef te garanderen. Een overzicht van het verloop van het onderzoek wordt weergegeven in Figuur~\ref{fig:gantt}. De onderzoeksperiode spreidt zich over \textbf{11 weken}, gevolgd door 3 weken waarin feedback kan worden verwerkt en de eindpresentatie kan worden voorbereid. Binnen de onderzoeksperiode zal er \textbf{wekelijks één tot twee dagen} gewerkt worden aan de bachelorproef: op de bachelorproefdag en, indien mogelijk, één dag in het weekend.
