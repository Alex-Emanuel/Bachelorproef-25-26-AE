...
Zoals in het begin van dit voorstel werd aangehaald, richt dit onderzoek zich op het zoeken naar een geschikte tool die jongvolwassen gebruikers in staat stelt om dark patterns op streamingdiensten te herkennen, en zo bewustwording rond dit onderwerp te creëren. Om de onderzoeksvraag te beantwoorden, wordt een weloverwogen plan gevolgd dat bestaat uit \textbf{zes verschillende fasen}. In eerste instantie wordt de huidige stand van zaken onderzocht aan de hand van literatuurstudie. Nadien worden hieruit de requirements waaraan de tool moet voldoen opgesteld. Vervolgens zal een longlist gemaakt worden van alle mogelijke oplossingen en zal deze verder vernauwd worden tot een shortlist die de beste ideeën bevat. Hieruit zal het beste alternatief gekozen en uitgewerkt worden als Proof of Concept. Tot slot zal uit dit onderzoek een conclusie geformuleerd worden. Naast deze gedefinieerde fasen wordt er tijdens het volledige verloop van het onderzoek continu documentatie bijgehouden. Iedere fase is zorgvuldig gepland om een optimaal verloop van de bachelorproef te garanderen. Een overzicht van het verloop van het onderzoek wordt weergegeven in Figuur~\ref{fig:gantt}. De onderzoeksperiode spreidt zicht over \textbf{11 weken}, gevolgd door 3 weken waarin feedback kan worden verwerkt en de eindpresentatie kan worden voorbereid. Binnen de onderzoeksperiode zal er \textbf{wekelijks één tot twee dagen} gewerkt worden aan de bachelorproef: op de bachelorproefdag en, indien mogelijk, één dag in het weekend.
...
Het doel van deze fase is het verder verwerven van kennis omtrent het probleemdomein, zodat in de volgende fase de requirements op een onderbouwde manier kunnen worden opgesteld. Dit resulteert zich in het uitwerken van een overzicht van gebruikersproblemen rond dark patterns op streamingdiensten, een lijst van populaire streamingdiensten en de patronen die ze bevatten, en een analyse van bestaande tools met hun sterke en zwakke punten.
...
Na het opstellen van de requirements zal er gezocht worden naar een zo groot mogelijk aantal digitale oplossingen die gebruikers kunnen helpen om dark patterns op streamingdiensten te herkennen. Door middel van aanvullend literatuuronderzoek, gebruikmakend van de voorgaande vermelde databanken, worden alle mogelijke oplossingen overwogen en opgelijst. Ieder alternatief zal worden afgetoetst aan de requirementslijst die werd opgesteld in fase~2 als ook worden de voor- en nadelen genoteerd. Op deze manier wordt er zekerheid ingebouwd dat er geen alternatief over het hoofd gezien wordt. Op het einde van fase~3 moet een longlist opgesteld zijn van alle mogelijke digitale oplossingen die geschikt zouden kunnen zijn om in een verder stadium verder uit te werken. Deze longlist zal dienen voor het opstellen van de shortlist in de volgende fase.
...
Fase~5, de fase die het meeste tijd in beslag zal nemen, omvat de uitwerking van een Proof of Concept (PoC). De geselecteerde oplossing uit fase~4 wordt in deze fase uitgewerkt tot een eerste Minimum Viable Product (MVP). In eerste instantie zullen er wireframes en mockups uitgewerkt worden in \emph{AdobeXD} om de algemene flow van de tool te bepalen. Nadien zullen in overleg met de co-promotor de meest geschikte technologieën (zoals \emph{React}, \emph{Node.js}, \emph{Python}, \ldots) gekozen worden. Daarna start de implementatie van de tool. Tijdens de ontwikkeling wordt er iteratief en agile gewerkt, waarbij elke iteratie het resultaat zal worden afgetoetst bij de co-promotor. Daarnaast zullen er testen geschreven worden die de goede werking van de tool controleren.

Aan het einde van de fase is er een werkend prototype die de belangrijkste functionaliteiten van de tool bevat, aangevuld met een korte documentatie over de werking en functionaliteiten. Op het einde van deze fase zal gevalideerd worden of de uitgewerkte tool al dan niet een oplossing biedt voor het gestelde probleem.
...
De laatste fase omvat het trekken van een conclusie over de werking van de uitgewerkte tool. Eveneens zal een antwoord geformuleerd worden op de onderzoeksvraag en zullen aanbevelingen opgesteld worden voor verder onderzoek. Tot slot worden de overblijvende hiaten in de tool geïdentificeerd. Hiervoor wordt een heuristische evaluatie uitgevoerd op basis van de requirements uit fase~2 en de UX-principes van Nielsen. De evaluatie wordt zowel door de onderzoeker als door de co-promotor uitgevoerd om objectiviteit te waarborgen. De bevindingen uit deze evaluatie worden gedocumenteerd en samengevat. Aan het einde van het onderzoek ligt er een duidelijk overzicht klaar: een conclusie die de onderzoeksvraag beantwoordt, aanbevelingen voor verdere ontwikkeling en onderzoek, en een lijst van overblijvende hiaten in de tool.
...
Het verwachte resultaat van dit onderzoek is een digitale tool die Vlamingen tussen 21 en 25 jaar helpt bij het opmerken van dark patterns op streamingdiensten zodat ze veiliger en bewuster met deze platformen omgaan. De tool zal hen ondersteunen bij het herkennen van misleidende ontwerpkeuzes en zal de gebruikers informeren over de intentie en gevaren ervan. Deze verwachting baseert zich op bevindingen uit de literatuurstudie, namelijk dat gebruikers regelmatig moeite hebben bij het herkennen van dark patterns \autocite{OECD2022} en dat ze niet bewust zijn van de gevaren ervan \autocite{BongardBlanchy2021}. Daarnaast wordt verwacht dat de tool geen AI-component zal bevatten aangezien uit de literatuurstudie gebleken is dat bestaande detectietools gebruikmakend van AI een beperkte dekking hebben \autocite{Nie2024} en dus onmogelijk alle patronen kunnen herkennen en ervoor waarschuwen. Eveneens wordt, naast de uitgewerkte tool, aangenomen dat het onderzoek inzichten zal geven in op welke manier gebruikers het best geïnformeerd en gewaarschuwd kunnen worden. 

\vspace{1em}

De verwachte meerwaarde van dit onderzoek voor de doelgroep ligt in het verhogen van hun bewustzijn over dark patterns en het vergroten van hun gevoel van controle bij het gebruik van streamingplatformen. De tool kan hen helpen bij het maken van bewustere keuzes doordat ze beter begrijpen hoe interfaces hen beïnvloeden. Verder biedt dit onderzoek waardevolle inzichten voor de wereld van UI/UX en softwareontwikkeling, doordat het kan dienen als voorbeeld voor het ontwerpen van soortgelijke tools in andere domeinen waar dark patterns voorkomen, zoals webshops of reiswebsites. Tot slot kan het onderzoek ook interessant zijn voor de opleiding Toegepaste Informatica aan HOGENT, omdat het bewustzijn creëert over het gebruik van dark patterns in digitale toepassingen en kan bijdragen aan discussies over hoe de opleiding binnen hun curriculum hier op een ethisch verantwoorde manier mee kan omgaan.
