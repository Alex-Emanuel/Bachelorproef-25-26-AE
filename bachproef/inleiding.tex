...
In Hoofdstuk~\ref{ch:longlist} wordt aan de hand van de literatuurstudie uit Hoofdstuk~\ref{ch:stand-van-zaken} een overzicht opgesteld van mogelijke digitale oplossingen die gebruikers kunnen helpen om dark patterns op streamingdiensten te herkennen.
