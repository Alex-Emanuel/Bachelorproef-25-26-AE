...
In eerste instantie werden er mockups uitgewerkt in \emph{Figma} om de algemene flow van de tool te bepalen. Nadien werden in overleg met de copromotoren en aan de hand van een korte aanvullende literatuurstudie de meest geschikte technologieën (zoals \emph{Java}, \emph{Python}, \ldots) gekozen. Daarna startte de implementatie van de tool.
...
Tot slot werden binnen dit hoofdstuk de antwoorden op deelvragen en hoofdonderzoeksvraag geformuleerd.
