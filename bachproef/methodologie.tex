...
De laatste fase omvat het trekken van een conclusie over de werking van de uitgewerkte tool en het identificeren van verbeterpunten en overblijvende hiaten. Dit gebeurde door de gerealiseerde functionaliteiten te vergelijken met de vereisten die in fase~2 opgesteld werden. Daarnaast werden observaties uit de gebruikerstesten meegenomen om hiaten te identificeren en mogelijke verbeterpunten te formuleren.

\vspace{1em}

Door het afronden van deze finale fase werd voldoende informatie verzameld om de laatste deelvraag van dit onderzoek te beantwoorden:
...
Tot slot werden binnen dit hoofdstuk de antwoorden op de deelvragen en de hoofdonderzoeksvraag geformuleerd.
