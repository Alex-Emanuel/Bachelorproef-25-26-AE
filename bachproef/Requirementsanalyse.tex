...
Naast het opstellen van de \acrshort{fr}'s en de \acrshort{nfr}'s, zijn er nog enkele aspecten die niet aan bod kwamen, maar wel rekening mee moet gehouden worden bij het uitwerken van de \acrshort{poc} binnen de scope van dit onderzoek.
...
Ten slotte wordt de scope van dit onderzoek beperkt tot de populairste streamingplatformen in Vlaanderen. De \acrshort{poc} richt zich daarom op platformen zoals Netflix, Disney+, Streamz en Amazon Prime Video.
