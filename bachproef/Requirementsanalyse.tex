...
Om de requirements verder te verfijnen, werden interviews afgenomen met vertegenwoordigers van de doelgroep en twee experten. De doelgroep bestond uit vier studenten binnen de opleiding Toegepaste Informatica en een junior developer, terwijl de experten bestonden uit een systeemarchitect en een product designer. De interviewvragen en antwoorden zijn terug te vinden in bijlage~\ref{ch:interviewvragen}. Op basis van deze gesprekken worden de belangrijkste inzichten hieronder kort samengevat.
...
\begin{itemize}
    \item Beide experten beschouwen dark patterns binnen streamingdiensten als een relevant probleem, waarbij vooral \textbf{ongewenste abonnementen, automatische verlengingen, gewoonwording en verslavend kijkgedrag} als mogelijke gevolgen worden aangehaald. 
    \item \textbf{Preselection}, \textbf{Hidden information} en \textbf{Obstruction} worden genoemd als meest impactvolle patronen.
    \item De detectie van dark patterns moet volgens de experten voornamelijk focussen op patronen die een grote impact hebben en technisch haalbaar zijn binnen de scope van een proof of concept. Hierbij worden onder andere \textbf{Preselection}, \textbf{Hidden information} en \textbf{False hierarchy} genoemd.
    \item Een belangrijke uitdaging bij automatische detectie is het correct interpreteren van de \textbf{context en intentie} achter een interface-element. Niet elk opvallend element vormt automatisch een dark pattern.
    \item Waarschuwingen moeten \textbf{informatief en transparant} zijn. De tool moet uitleg geven over het gedetecteerde patroon en een betrouwbaarheidsniveau weergeven.
    \item Beide experten benadrukken het belang van \textbf{gebruikerscontrole}. Gebruikers moeten zelf kunnen bepalen welke meldingen zij ontvangen, hoe frequent deze verschijnen en hoe deze worden weergegeven.
    \item Een overdaad aan waarschuwingen kan leiden tot \textbf{waarschuwingsmoeheid}, waardoor gebruikers meldingen gaan negeren of de tool verwijderen. Daarom moeten meldingen beperkt, relevant en kwalitatief zijn.
    \item De scope van een eerste proof of concept moet beperkt blijven tot de \textbf{kernfunctionaliteiten}. Een te uitgebreide implementatie met verschillende rollen of complexe detecties kan de haalbaarheid van de \acrshort{poc} in gevaar brengen.
    \item De experten gaven nog enkele opmerkingen met betrekking tot de huidige requirements. Deze kunnen geraadpleegd worden bij de laatste vraag in sectie~\ref{sec:interviews-experten}.
\end{itemize}
...
\begin{itemize}
    ...
    \item De \acrshort{fr} ``Instellen van de frequentie van notificaties'' wordt toegevoegd met prioriteit ``Should have''.
    ...
    \item De \acrshort{fr} ``Doorlopen van een onboarding bij het eerste gebruik'' wordt toegevoegd met prioriteit ``Should have'' om gebruikers vertrouwd te maken met de werking en meerwaarde van de tool.
    \item De \acrshort{fr} ``Uitvoeren van een educatieve meting over de kennis van dark patterns'' wordt toegevoegd met als prioriteit ``Could have''.
\end{itemize}
...
Op basis van de uitgevoerde interviews en de hieruit verkregen inzichten wordt een vernieuwde lijst van \acrshort{fr}'s en \acrshort{nfr}'s opgesteld voor de detectie- en signaleringstool binnen deze casus. Deze requirements vormen de basis voor het verdere ontwerp en de implementatie van een eerste proof of concept.

\vspace{1em}

Tijdens het interview benadrukte S. Hostyn het belang van het bewaken van de scope van de \acrshort{poc}. Daarom worden requirements waarmee tijdens de ontwikkeling van de eerste \acrshort{poc} geen rekening wordt gehouden visueel minder prominent weergegeven door deze in een lichtgrijze kleur aan te duiden. De focus ligt voornamelijk op de \textbf{Must have}-requirements en enkele geselecteerde \textbf{Should have}-requirements die een duidelijke meerwaarde bieden voor het aantonen van de kernfunctionaliteiten. Voor de \acrshort{nfr}'s worden voornamelijk de vereisten geselecteerd die relevant en haalbaar zijn binnen de beperkte scope van een proof of concept.
...
% \caption[Definitieve functionele requirements]{\label{tab:newfrs}Definitieve geprioriteerde lijst van functionele requirements op basis van de MoSCoW-methode} \\

Legende: \enspace \textcolor{red}{\textbf{\bol}} Must have 
...
\begin{longtable}{%
    ...
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Aanvragen van een specialist- of handhaverrol} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Gebruiker+} &
    \textcolor{customlightgray}{Aanmelden} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Melden van mogelijk niet-gedetecteerde dark patterns} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Raadplegen van juridische informatie en privacybeleid} &
    \textcolor{orange}{\bol} \\
    ...
    \textcolor{customlightgray}{Handhaver} &
    \textcolor{customlightgray}{Raadplegen van de toepasselijke wetgeving bij dark patterns} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Raadplegen van de vermoedelijke businessdoelstelling achter een dark pattern} &
    \textcolor{ForestGreen}{\bol} \\
    ...
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Uitvoeren van een educatieve meting over de kennis van dark patterns} &
    \textcolor{ForestGreen}{\bol} \\
    ...
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Instellen van de frequentie van notificaties} &
    \textcolor{orange}{\bol} \\
    ...
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Raadplegen van de tijd besteed op streamingplatformen} &
    \textcolor{customlightgray}{\bol} \\
    ...
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Instellen welke dark patterns gedetecteerd worden} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Gebruiker} &
    \textcolor{customlightgray}{Instellen welke dark-patterncategorieën gedetecteerd worden} &
    \textcolor{ForestGreen}{\bol} \\
    ...
    \textcolor{customlightgray}{Handhaver} &
    \textcolor{customlightgray}{Indienen van wijzigingsvoorstellen voor juridische informatie} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Specialist} &
    \textcolor{customlightgray}{Melden van foutieve detecties met gecorrigeerde informatie} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Specialist} &
    \textcolor{customlightgray}{Indienen van aanvullende informatie bij detecties} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Beheerder} &
    \textcolor{customlightgray}{Raadplegen van foutieve detecties gerapporteerd door specialisten} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Beheerder} &
    \textcolor{customlightgray}{Beoordelen van voorstellen voor aanvullende informatie} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Beheerder} &
    \textcolor{customlightgray}{Beheren van juridische wijzigingsvoorstellen} &
    \textcolor{ForestGreen}{\bol} \\
    
    \textcolor{customlightgray}{Beheerder} &
    \textcolor{customlightgray}{Beheren van gebruikersrollen} &
    \textcolor{ForestGreen}{\bol} \\
...
\textcolor{customlightgray}{\hspace*{1.5em}\textbf{Capaciteit}}

\begin{itemize}
    \item \textcolor{customlightgray}{Minimaal 5 verschillende detecties moeten gelijktijdig uitgevoerd kunnen worden \textit{(bij snel wijzigen van een scherm)}.}
    \item \textcolor{customlightgray}{Minimaal 20 voorgaande detecties moeten opgeslagen kunnen worden in de detectiegeschiedenis.}
\end{itemize}
...
\begin{itemize}
    \item De applicatie moet gebruikers waarschuwen wanneer de juiste machtigingen voor Accessibility Services niet gegeven zijn.
    \item Meldingen over gedetecteerde dark patterns mogen de gebruiker niet onderbreken tijdens het bekijken van content, enkel in het begin, op het einde of buiten de content.
\end{itemize}
...
\subsubsection{\textcolor{customlightgray}{Beveiligbaarheid}}
\vspace{1em}

\textcolor{customlightgray}{\hspace*{1.5em}\textbf{Authenticiteit}}

\begin{itemize}
    \item \textcolor{customlightgray}{Beheerders moeten zich authenticeren voordat beheerfunctionaliteiten beschikbaar zijn.}
    \item \textcolor{customlightgray}{Specialisten moeten zich authenticeren voordat validatiefuncties beschikbaar zijn.}
    \item \textcolor{customlightgray}{Handhavers moeten zich authenticeren voordat wijzigingsvoorstellen voor juridische informatie ingediend kunnen worden.}
\end{itemize}
...
\textcolor{customlightgray}{\hspace*{1.5em}\textbf{Wijzigbaarheid}}

\begin{itemize}
    \item \textcolor{customlightgray}{Nieuwe wetgeving en uitleg over een patroon moet toegevoegd kunnen worden zonder wijzigingen door te voeren aan de detectielogica.}
\end{itemize}
...
\begin{itemize}
    \item Tijdens de gebruikersevaluatie mag de applicatie geen kritieke crash vertonen.
    \item Minstens 9 op de 10 detecties moet succesvol verwerkt worden.
\end{itemize}

\vspace{0.5em}

\textcolor{customlightgray}{\hspace*{1.5em}\textbf{Foutbestendigheid}}}

\begin{itemize}
    \item \textcolor{customlightgray}{Wanneer een detectie mislukt door een netwerk- of interne fout, moet de applicatie binnen 5 seconden terugkeren naar een operationele toestand zonder herstart.}
\end{itemize}
...
Ten slotte wordt de scope van dit onderzoek beperkt tot de populairste streamingplatformen in Vlaanderen. De \acrshort{poc} richt zich daarom op platformen zoals Netflix, Disney+ en Streamz. Meer bepaald zal binnen dit onderzoek de \acrshort{poc} getest worden op het streamingplatform Netflix.