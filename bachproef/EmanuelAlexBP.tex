...
\newcommand{\kruisje}{\ding{55}}
\newcommand{\bol}{\ding{108}}

\usepackage{placeins}

\definecolor{customlightgray}{RGB}{180,180,180}
...
\newacronym{ucpd}{UCPD}{Unfair Commercial Practices Directive}
\newacronym{gdpr}{GDPR}{General Data Protection Regulation}
\newacronym{dsa}{DSA}{Digital Services Act}
\newacronym{oss}{OSS}{Open Source Software}
\newacronym{fr}{FR}{Functionele Requirements}
\newacronym{nfr}{NFR}{Niet-Functionele Requirements}
...
% Verwijzing naar interviewvragen 

\chapter{Vragenlijst interviews}
\label{ch:interviewvragen}

Om de eerste versie van de requirements te verfijnen werden zeven interviews afgenomen. Vijf respondenten behoren tot de doelgroep van dit onderzoek, de overige respondenten zijn experten binnen het vakgebied. De vragen als ook een samenvatting van de antwoorden worden in deze bijlage opgenomen.
...
Om uit de shortlist de meest beloftevolle tool te kiezen waarmee verder is gewerkt in dit onderzoek, werden bij iedere tool dezelfde screenshots geanalyseerd. Zo is gestaafd welke bestaande analysesoftware de meeste patronen correct herkent. Deze screenshots werden in deze bijlage opgenomen. Ze zijn deels afkomstig uit de apps van Netflix en Amazon Prime Video en werden zowel opgeslagen in de Nederlandstalige als Engelstalige versie. Patronen die hierin niet meteen vindbaar waren, zijn geanalyseerd op basis van schermopnames uit voorgaand onderzoek van \textcite{Nygren2024}. Deze werden eveneens in deze bijlage opgenomen.
